...
enum class HxtpError : uint16_t {
    ...
    /* Transport errors */
    MQTT_CONNECT_FAILED         = 3001,
    MQTT_PUBLISH_FAILED         = 3002,
    MQTT_SUBSCRIBE_FAILED       = 3003,
...
inline const char* hxtp_error_str(HxtpError e) {
    switch (e) {
        ...
        case HxtpError::MQTT_CONNECT_FAILED:        return "MQTT_CONNECT_FAILED";
        case HxtpError::MQTT_PUBLISH_FAILED:        return "MQTT_PUBLISH_FAILED";
        case HxtpError::MQTT_SUBSCRIBE_FAILED:      return "MQTT_SUBSCRIBE_FAILED";
