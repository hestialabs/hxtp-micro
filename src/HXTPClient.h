...
#include "../core/hxtp_errors.h"
#include "../core/hxtp_core.h"
...
/* TLS client selection */
    ...
    #include "../esp32/hxtp_platform_esp32.h"
    #include "../esp32/hxtp_storage_nvs.h"
#elif defined(ESP8266)
    #include <ESP8266WiFi.h>
    #include <WiFiClientSecure.h>
    #include "../esp8266/hxtp_platform_esp8266.h"
#endif
...
enum class HxtpClientState : uint8_t {
    ...
    MQTT_CONNECTING = 4,    /* Connecting to MQTT broker */
    MQTT_CONNECTED  = 5,    /* MQTT up, subscribing */
